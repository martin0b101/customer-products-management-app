<template>
    <form class="m-80" @submit.prevent="handleSignin">
        <div class="mb-6">
            <h1 class="text-2xl font-bold tracking-wide">Prijava DIS</h1>
        </div>
        <div class="mb-6">
        ...
        <button @click="handleSignin" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Prijava</button>
    </form> 
</template>
